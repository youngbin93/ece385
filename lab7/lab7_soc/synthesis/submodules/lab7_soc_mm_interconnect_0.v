...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire   [28:0] buttons_s1_agent_m0_address;                                                        // buttons_s1_agent:m0_address -> buttons_s1_translator:uav_address
	...
	wire  [105:0] buttons_s1_agent_rf_source_data;                                                    // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] buttons_s1_agent_rsp_fifo_out_data;                                                 // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> buttons_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // buttons_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> buttons_s1_agent:cp_channel
	...
	wire  [104:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [104:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [104:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_009:sink_data
